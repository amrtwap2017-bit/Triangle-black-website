...
export const translations: Record<Lang, Translation> = {
  ...
  en: {
    ...
    hero: {
      badge: 'Premium Engineering Hub',
      headline: 'MEP Engineering For Hotels',
      desc: 'Certified mechanical supplies, lifecycle procurement, and round-the-clock maintenance protocols engineered exclusively for 5-star hospitality operations.',
      ctaPrimary: 'Request Quotation',
      ctaSecondary: 'View Projects',
      kpi1: '500+',
      kpi1Sub: 'Projects Delivered',
      kpi2: '100%',
      kpi2Sub: 'OEM Certified',
      kpi3: '<4 Hrs',
      kpi3Sub: 'Emergency Response',
      kpi4: '15+',
      kpi4Sub: 'Years Experience',
    ...
    highlight: {
      badge: 'Our Journey',
      heading: 'Building Legacy Excellence',
      desc: 'From humble beginnings to becoming the region\'s most trusted hospitality engineering partner.',
      timeline: [
        { year: '2008', title: 'Foundation', description: 'Triangle Black was established with a vision to revolutionize hospitality engineering in the MENA region.' },
        { year: '2012', title: 'Regional Expansion', description: 'Expanded operations across Egypt, UAE, and Saudi Arabia with dedicated technical teams.' },
        { year: '2018', title: 'OEM Partnerships', description: 'Secured exclusive partnerships with leading European and American equipment manufacturers.' },
        { year: '2024', title: 'Industry Leader', description: 'Recognized as the premier hospitality MEP solutions provider with 500+ completed projects.' },
      ],
      quote: 'Engineering excellence is not just about technical precision—it\'s about understanding that every hotel system impacts guest experiences.',
    ...
    about: {
      ...
      p1: 'Triangle Black stands as the region\'s foremost hospitality engineering solutions provider, delivering precision-engineered MEP systems and maintenance protocols to luxury hotels across the Middle East and Africa.',
      p2: 'Our commitment to operational excellence ensures zero mechanical blindspots, with every component sourced from certified OEM partners and installed by factory-trained technicians.',
      missionTitle: 'Our Mission',
      missionDesc: 'To deliver uncompromising engineering solutions that ensure every hospitality property operates at peak performance, every day.',
      visionTitle: 'Our Vision',
      visionDesc: 'To be the most trusted name in hospitality MEP engineering, setting the global standard for technical excellence and operational reliability.',
      valuesTitle: 'Our Values',
      valuesDesc: 'Precision, integrity, and relentless pursuit of excellence in every project we undertake, no matter the scale.',
  ...
  ar: {
    ...
    hero: {
      badge: 'مركز الهندسة المتميز',
      headline: 'هندسة MEP للفنادق',
      desc: 'مستلزمات ميكانيكية معتمدة، ومشتريات دورة الحياة، وبروتوكولات صيانة على مدار الساعة مصممة حصرياً لعمليات الضيافة من فئة 5 نجوم.',
      ctaPrimary: 'طلب عرض سعر',
      ctaSecondary: 'عرض المشاريع',
      kpi1: '+500',
      kpi1Sub: 'مشروع منجز',
      kpi2: '100%',
      kpi2Sub: 'معتمد من OEM',
      kpi3: '<4 ساعات',
      kpi3Sub: 'استجابة الطوارئ',
      kpi4: '+15',
      kpi4Sub: 'سنة خبرة',
    ...
    highlight: {
      ...
      desc: 'من بدايات متواضعة إلى أن أصبحنا الشريك الهندسي الأكثر ثقة في مجال الضيافة بالمنطقة.',
      timeline: [
        { year: '2008', title: 'التأسيس', description: 'تأسست تراينجل بلاك برؤية لإحداث ثورة في هندسة الضيافة في منطقة الشرق الأوسط وشمال أفريقيا.' },
        { year: '2012', title: 'التوسع الإقليمي', description: 'توسعت العمليات عبر مصر والإمارات والسعودية مع فرق تقنية متخصصة.' },
        { year: '2018', title: 'شراكات OEM', description: 'حصلنا على شراكات حصرية مع كبرى الشركات المصنعة للمعدات الأوروبية والأمريكية.' },
        { year: '2024', title: 'الريادة في الصناعة', description: 'معترف بنا كمزود رائد لحلول MEP للضيافة مع أكثر من 500 مشروع مكتمل.' },
      ],
      quote: 'التميز الهندسي لا يتعلق فقط بالدقة التقنية — إنه يتعلق بفهم أن كل نظام فندقي يؤثر على تجارب الضيوف.',
