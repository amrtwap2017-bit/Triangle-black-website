...
export const translations: Record<Lang, Translation> = {
  ...
  ar: {
    ...
    highlight: {
      ...
      timeline: [
        { year: '2014', title: 'التأسيس', description: 'بدأت رحلتنا من قلب النهضة العمرانية في مصر. من خلال "ءالخطيب للتوريدات"، ساهمنا في أضخم المشاريع القومية، بما في ذلك العاصمة الإدارية الجديدة. لم نكن مجرد موردين، بل أدرنا تدفقات هندسية تجاوزت 10 ملايين جنيه سنوياً، مما منحنا فهماً عميقاً لتعقيدات البيئات الهندسية عالية الكثافة.' },
